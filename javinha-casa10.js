...
const background = new Sprite({
  ...
  imageSrc: 'imgs-jogo/casaDeCapricornio.png'
})
...
const ini = new Fighter({
 ...
 scale: 2.3,
  ...
  sprites: {
    ...
    run: {
      imageSrc: 'imgs-jogo/ouro/CapCorre.png',
      framesMax: 8
    },
    jump: {
      imageSrc: 'imgs-jogo/ouro/CapPula.png',
      framesMax: 2
    },
    fall: {
      imageSrc: 'imgs-jogo/ouro/CapCai.png',
      framesMax: 1
    },
    attack1: {
      imageSrc: 'imgs-jogo/ouro/CapAtaque1.png',
      framesMax: 3
    },
    takeHit: {
      imageSrc: 'imgs-jogo/ouro/CapAtacado.png',
      framesMax: 3
    },
    death: {
      imageSrc: 'imgs-jogo/ouro/CapPerde.png',
      framesMax: 4
    }
  },
  ataqueBox: {
