...
const background = new Sprite({
  ...
  imageSrc: 'imgs-jogo/casaDePeixes.png'
})
...
const player = new Fighter({
  ...
  imageSrc: 'imgs-jogo/bronze/SParado.png',
  framesMax: 4,
  scale: 2.5,
  offset: {
    x: -50,
  ...
  sprites: {
    ...
    run: {
      imageSrc: 'imgs-jogo/bronze/SCorre.png',
      framesMax: 8
    },
    jump: {
      imageSrc: 'imgs-jogo/bronze/SPula.png',
      framesMax: 1
    },
    fall: {
      imageSrc: 'imgs-jogo/bronze/SCai.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: 'imgs-jogo/bronzeSAtaque1.png',
      framesMax: 10
    },
    takeHit: {
      imageSrc: 'imgs-jogo/bronze/SAtacado.png',
      framesMax: 4
    },
    death: {
      imageSrc: 'imgs-jogo/bronze/SPerde.png',
      framesMax: 4
    }
  },
  ataqueBox: {
...
const ini = new Fighter({
  ...
  imageSrc: 'imgs-jogo/ouro/EParado.png',
  framesMax: 2,
  scale: 2.5,
  offset: {
    x: -50,
  ...
  sprites: {
    idle: {
      imageSrc: 'imgs-jogo/ouro/PParado.png',
      framesMax: 2
    },
    run: {
      imageSrc: 'imgs-jogo/ouro/PCorre.png',
      framesMax: 8
    },
    jump: {
      imageSrc: 'imgs-jogo/ouro/PPula.png',
      framesMax: 2
    },
    fall: {
      imageSrc: 'imgs-jogo/ouro/PCai.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: 'imgs-jogo/ouro/PAtaque1.png',
      framesMax: 10
    },
    takeHit: {
      imageSrc: 'imgs-jogo/ouro/PAtacado.png',
      framesMax: 3
    },
    death: {
      imageSrc: 'imgs-jogo/ouro/PPerde.png',
      framesMax: 3
    }
  },
  ataqueBox: {
