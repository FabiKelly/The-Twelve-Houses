...
const background = new Sprite({
  ...
  imageSrc: 'imgs-jogo/casaDeEscorpiao.png'
})
...
const player = new Fighter({
  ...
  imageSrc: 'imgs-jogo/bronze/HParado.png',
  framesMax: 4,
  scale: 2.5,
  offset: {
    x: -50,
  ...
  sprites: {
    ...
    run: {
      imageSrc: 'imgs-jogo/bronze/HCorre.png',
      framesMax: 8
    },
    jump: {
      imageSrc: 'imgs-jogo/bronze/HPula.png',
      framesMax: 2
    },
    fall: {
      imageSrc: 'imgs-jogo/bronze/HCai.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: 'imgs-jogo/bronze/HAtaque1.png',
      framesMax: 9
    },
    takeHit: {
      imageSrc: 'imgs-jogo/bronze/HAtacado.png',
      framesMax: 4
    },
    death: {
      imageSrc: 'imgs-jogo/bronze/HPerde.png',
      framesMax: 4
    }
  },
  ataqueBox: {
...
const ini = new Fighter({
  ...
  sprites: {
    ...
    run: {
      imageSrc: 'imgs-jogo/ouro/ECorre.png',
      framesMax: 8
    },
    jump: {
      imageSrc: 'imgs-jogo/ouro/EPula.png',
      framesMax: 2
    },
    fall: {
      imageSrc: 'imgs-jogo/ouro/ECai.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: 'imgs-jogo/ouro/EAtaque1.png',
      framesMax: 10
    },
    takeHit: {
      imageSrc: 'imgs-jogo/ouro/EAtacado.png',
      framesMax: 3
    },
    death: {
      imageSrc: 'imgs-jogo/ouro/EPerde.png',
      framesMax: 2
    }
  },
  ataqueBox: {
