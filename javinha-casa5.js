...
const background = new Sprite({
  ...
  imageSrc: 'imgs-jogo/casaDeLeao.png'
})
...
const ini = new Fighter({
  ...
  sprites: {
    ...
    run: {
      imageSrc: 'imgs-jogo/ouro/LCorre.png',
      framesMax: 8
    },
    jump: {
      imageSrc: 'imgs-jogo/ouro/LPula.png',
      framesMax: 2
    },
    fall: {
      imageSrc: 'imgs-jogo/ouro/LCai.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: 'imgs-jogo/ouro/LAtaque1.png',
      framesMax: 11
    },
    takeHit: {
      imageSrc: 'imgs-jogo/ouro/LAtacado.png',
      framesMax: 3
    },
    death: {
      imageSrc: 'imgs-jogo/ouro/LPerde.png',
      framesMax: 2
    }
  },
  ataqueBox: {
