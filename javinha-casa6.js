...
const background = new Sprite({
  ...
  imageSrc: 'imgs-jogo/casaDeVirgem.png'
})
...
const player = new Fighter({
  ...
  imageSrc: 'imgs-jogo/bronze/IParado.png',
  framesMax: 4,
  scale: 2.5,
  offset: {
    x: -50,
  ...
  sprites: {
    ...
    run: {
      imageSrc: 'imgs-jogo/bronze/ICorre.png',
      framesMax: 8
    },
    jump: {
      imageSrc: 'imgs-jogo/bronze/IPula.png',
      framesMax: 1
    },
    fall: {
      imageSrc: 'imgs-jogo/bronze/ICai.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: 'imgs-jogo/bronze/IAtaque1.png',
      framesMax: 23
    },
    takeHit: {
      imageSrc: 'imgs-jogo/bronze/IAtacado.png',
      framesMax: 4
    },
    death: {
      imageSrc: 'imgs-jogo/bronze/IPerde.png',
      framesMax: 4
    }
  },
  ataqueBox: {
...
const ini = new Fighter({
  ...
  imageSrc: 'imgs-jogo/ouro/VParado.png',
  framesMax: 3,
  scale: 2.5,
  offset: {
    x: -50,
  ...
  sprites: {
    ...
    run: {
      imageSrc: 'imgs-jogo/ouro/VCorre.png',
      framesMax: 8
    },
    jump: {
      imageSrc: 'imgs-jogo/ouro/VPula.png',
      framesMax: 2
    },
    fall: {
      imageSrc: 'imgs-jogo/ouro/VCai.png',
      framesMax: 2
    },
    attack1: {
      imageSrc: 'imgs-jogo/ouro/VAtaque1.png',
      framesMax: 6
    },
    takeHit: {
      imageSrc: 'imgs-jogo/ouro/VAtacado.png',
      framesMax: 3
    },
    death: {
      imageSrc: 'imgs-jogo/ouro/VPerde.png',
      framesMax: 7
    }
  },
  ataqueBox: {
